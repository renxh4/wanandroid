...
public class QuestionAdapter extends BaseAdapter<QuestionBean.DataDTO.DatasDTO, QuestionAdapter.QuestionViewHolder> {
    ...
    @Override
    public void cover(RecyclerView.ViewHolder holder, int position, QuestionBean.DataDTO.DatasDTO datasDTO) {
        if (holder instanceof QuestionViewHolder){
            ...
            if (datasDTO.getTags().size() > 0) {
                ...
                QuestionBean.DataDTO.DatasDTO.TagsDTO tag = datasDTO.getTags().get(0);
